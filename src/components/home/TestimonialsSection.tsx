export default function TestimonialsSection() {
  ...
  return (
    <section className="py-16 bg-surface-container-lowest border-t border-outline-variant/20 px-margin-mobile lg:px-margin-desktop">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map((rev, idx) => (
            <div 
              key={idx}
              className="bg-surface-container/40 border border-outline-variant/20 p-6 flex flex-col justify-between"
            >
              ...
              <div className="border-t border-outline-variant/10 pt-3 flex justify-between items-center">
                <span className="font-headline-sm text-sm text-on-surface font-semibold">{rev.name}</span>
